...
def create_str_token_mapping(df):
    ...
    dill.dump(obj={'diag_voc': diag_voc, 'med_voc': med_voc, 'pro_voc': pro_voc},
              file=open('output/mimic-iii/voc_final.pkl', 'wb'))
...
def create_patient_record(df, diag_voc, med_voc, pro_voc):
    ...
    dill.dump(obj=records, file=open('output/mimic-iii/records_final.pkl', 'wb'))
    return records
...
def get_ddi_matrix(records, med_voc, ddi_file):
    ...
    dill.dump(ehr_adj, open('output/mimic-iii/ehr_adj_final.pkl', 'wb'))
    ...
    dill.dump(ddi_adj, open('output/mimic-iii/ddi_A_final.pkl', 'wb'))
...
if __name__ == '__main__':
    ...
    med_structure_file = './input/atc3toSMILES.pkl'
    ...
    atc3toSMILES_file = "output/mimic-iii/atc3toSMILES.pkl"
